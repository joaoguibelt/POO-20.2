   ...
   //Altura e Largura da janela 
    ...
    public Jogo(){
        ...
        try {
            ...
            System.out.println("Arquivo do funso não encontrado");
    ...
    private void tick() {
        ...
        if(estadoJogo == ESTADO.Jogo){
            try{
                ...
                System.out.println("Arquivo de scores não encontrado");
            }
            try{
                cria.tick();
            } catch(IOException ex){
                System.out.println("Arquivo de inimigo não encontrado");
            }
            explosao.tick();
        }
